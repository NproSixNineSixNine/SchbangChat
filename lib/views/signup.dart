          ...
          passwordEditingController.text).then((result){
            if(result != null){
              ...
              FirebaseMessaging.instance.getToken().then((value) async {
                String? token = value;
                if(await HelperFunctions.getUserFcmTokenPreference() != value){
                  HelperFunctions.saveUserFcmTokenPreference(token!);
                }
      ...
      body: isLoading ? Container(child: Center(child: CircularProgressIndicator(),),) :  Container(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: (){
                authService.signInWithGoogle(context).then((result) async {
                  if(result != null){
